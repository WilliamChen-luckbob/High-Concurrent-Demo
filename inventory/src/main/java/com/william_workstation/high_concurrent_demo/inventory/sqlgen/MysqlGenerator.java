package com.william_workstation.high_concurrent_demo.inventory.sqlgen;
...
public class MysqlGenerator {
    ...
    private static void shell(String model, String table) {
        ...
        dsc.setUrl("jdbc:mysql://10.168.1.245:3306/demo_inventory?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
        ...
        pc.setParent("com.william_workstation.high_concurrent_demo.inventory");
        pc.setEntity("entity");
        ...
        if (true) {//path.contains("service")) {
            ...
            focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return path + "/src/main/resources/com/william_workstation/high_concurrent_demo/inventory/mapper"
